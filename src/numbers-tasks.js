...
function getRandomInteger(min, max) {
  ...
  const randomDecimal = Math.random(); // Random decimal between 0 (inclusive) and 1 (exclusive)
  const randomInteger = Math.floor(randomDecimal * (max - min + 1)) + min; // Scale and shift
